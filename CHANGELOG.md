...
- Made GCA/GCF harmonization version-aware and RefSeq-preferred without dropping GCA-only assemblies.
...
- Added a new PanGenFlow workflow figure and clarified optional downstream use with PanPhyloFlow.
